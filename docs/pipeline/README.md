...
3. `docs/pipeline/02-method-understanding-step.md`
...
- `docs/pipeline/99-legacy-qa-generation-step.md`
...
- **Artifact（工件）**：step 间共享的文件（例如 `symbols.jsonl`、`auto_qa_raw.jsonl`、`all_dedup.jsonl`）。
